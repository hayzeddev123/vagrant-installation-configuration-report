...
All screenshots used in this project are stored in the `images/` directory and are **embedded directly** in the main [README.md](README.md) using standard Markdown image syntax.
...
**File:** `images/Screenshot 2026-08-05 171236.png`
...
**File:** `images/Screenshot 2026-08-05 171559.png`
...
```markdown
![Vagrantfile and terminal session](images/Screenshot%202026-08-05%20171236.png)
```
